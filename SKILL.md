...
| **kirby-aiseo-skill** | Modular AI SEO, GEO, AEO protocol for on-page & technical architecture. | `seo`, `aiseo`, `geo`, `aeo`, `crawl-depth`, `content-pruning`, `crawled-not-indexed` |
...
| **kirby-seo-telemetry** | AI attribution capture, GSC telemetry, coverage hygiene & pogo-sticking defense. | `seo-attribution`, `gsc-telemetry`, `pogo-sticking`, `reddit-gsc`, `gsc-coverage` |
